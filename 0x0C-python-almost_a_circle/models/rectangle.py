#!/usr/bin/python3
'''this module defnes a rectangle class'''
...
class Rectangle(Base):
    ...
    @property
    def height(self):
        ''''gets the value for the height of the rectangle'''
        return self.__width
    ...
    @property
    def x(self):
        ''''gets the value for x of the rectangle'''
        return self.__x
    ...
    @property
    def y(self):
        '''gets the value for y of the rectangle'''
        return self.__y
    ...
    def area(self):
        '''updating the class Rectangle by defining the area of the rectangle'''
        return self.width * self.height

    
    def display(self):
        '''updating the class Rectangle. using the `#` character to print the rectangle'''
